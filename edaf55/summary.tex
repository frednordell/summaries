...
\textsc{\Large EDAF55}\\[0.5cm] % Major heading such as course name
\textsc{\large Concurrent and Real-Time Programming}\\[0.5cm] % Minor heading such as course title

\HRule \\[1cm]
{ \huge \bfseries Summary of EDAF55}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
